...
| **High Intel/AI**   | "deep thinking", "fallback", "piramyd"     | `piramyd-oracle`                            | ✅ YES       |
| **Elite Coding**    | "complex logic", "refactor major"          | `piramyd-coder`                             | ✅ YES       |
...
| **AI/Intel**    | piramyd, oracle, thinking, fallback        | `piramyd-oracle`        |
| **Coding Elite**| coder, expert, complex, refine             | `piramyd-coder`         |
